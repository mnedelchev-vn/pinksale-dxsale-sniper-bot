![alt text](https://github.com/mnedelchev-vn/dxsale-sniper-bot/blob/master/assets/images/dxsale-logo-shadow.png)
...
**WARNING!** - This is a sample Presale address, do not use it! Each token DxSale has unique Presale contract address.
